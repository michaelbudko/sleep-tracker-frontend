      ...
      <table className="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{avgSleepTime[0]}</td>
            <td>{avgSleepTime[1]}</td>
            <td>{avgSleepTime[2]}</td>
          </tr>
          <tr>
            <td>
                <div className="info text-start ps-5 pt-3">
            ...
            <td>{avgTimeInBed[0]}</td>
            <td>{avgTimeInBed[1]}</td>
            <td>{avgTimeInBed[2]}</td>
          </tr>
          <tr>
            <td>
                <div className="info text-start ps-5 pt-3">
            ...
            <td>{avgSleepEfficiency[0]}</td>
            <td>{avgSleepEfficiency[1]}</td>
            <td>{avgSleepEfficiency[2]}</td>
          </tr>
          <tr>
            <td>
                <div className="info text-start ps-5 pt-3">
            ...
            <td>{avgSleepQuality[0]}</td>
            <td>{avgSleepQuality[1]}</td>
            <td>{avgSleepQuality[2]}</td>
          </tr>
          <tr>
            <td>
                <div className="info text-start ps-5 pt-3">
